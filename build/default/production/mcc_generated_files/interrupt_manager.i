...
# 48 "mcc_generated_files/interrupt_manager.c"
# 1 "mcc_generated_files/interrupt_manager.h" 1
# 110 "mcc_generated_files/interrupt_manager.h"
void interrupt INTERRUPT_InterruptManager(void);
# 48 "mcc_generated_files/interrupt_manager.c" 2
...
void interrupt INTERRUPT_InterruptManager (void)
{
    ...
    else if(INTCONbits.PEIE == 1 && PIE3bits.TMR6IE == 1 && PIR3bits.TMR6IF == 1)
    {
        TMR6_ISR();
    }
